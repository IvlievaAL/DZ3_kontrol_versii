...
В папке, ставшей по воле владельца гита репозиторием, может лежать несколько файлов. Каких - зависит от конкретного случая: несколько текстов, картинки для вставки в текст, etc. Гит видит все эти файлы: и если они в гит не добавлены (*git add имяфайла*), т.е. он их не отслеживает, всякий раз статус будет напоминать, что они есть и не отслеживаются (и буковку U рисовать напротив них в списке файлов).
