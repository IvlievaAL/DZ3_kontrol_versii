...
Отменить те изменения, что были зафиксированы в данном коммите: *git revert номеркоммита* Для гита это будет выглядеть не как удаление упомянутого коммита, а как создание еще одного, нового, коммита, в котором прописано "отменить коммит такой-то".
